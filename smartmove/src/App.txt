    ...
    <div style={{ display:"flex", flexDirection:"column", gap:18 }}>
      ...
      {error && (
        <div style={{ background:C.redSoft, border:`1px solid ${C.red}44`, borderRadius:12, padding:"14px 18px", color:C.red, fontSize:13 }}>
          ⚠ {error}
          <div style={{ fontSize:11, marginTop:6, color:C.muted }}>Error loading from Google Sheets CSV. Sheet ID: {SHEET_ID_MAIN.slice(0,8)}... Make sure sheet is shared as Anyone with the link.</div>
        </div>
      )}
